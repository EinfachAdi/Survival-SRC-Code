...
public class lightning_bolt_altar extends Block {
    public lightning_bolt_altar(Settings settings) {
        super(settings);
    }
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if (entity instanceof ItemEntity itemEntity) {
            if (isValidItem(itemEntity.getStack())) {
                itemEntity.setStack(new ItemStack(ModOverworldItems.LIGHTNING_BOLT_SPAWN, itemEntity.getStack().getCount()));
        }
    }
