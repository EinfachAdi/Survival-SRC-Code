...
public class evoker_fangs_altar extends Block {
    public evoker_fangs_altar(Settings settings) {
        super(settings);
    }
    ...
    public void onSteppedOn(World world, BlockPos pos, BlockState state, Entity entity) {
        if (entity instanceof ItemEntity itemEntity) {
            if (isValidItem(itemEntity.getStack())) {
                itemEntity.setStack(new ItemStack(ModOverworldItems.EVOKER_FANGS_SPAWN, itemEntity.getStack().getCount()));
        }
    }
